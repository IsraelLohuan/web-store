            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Atualização de pedido</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              O status do seu pedido em nossa loja foi alterado pela gerência, qualquer dúvida em relação pode entrar em contato. Fique por dentro e acompanhe seu pedido por dentro de nosso APP!
                            </td>
                          </tr>
                        </table>
                        Novo status: <?php echo htmlspecialchars( $status, ENT_COMPAT, 'UTF-8', FALSE ); ?>

                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Obrigado!</p>
                              <p class="body-signature"><img src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="MaxClock Store"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>Dúvidas? Entre em contato pelo nosso e-mail, ou direct do instagram.</b></a> 
          </div>
        </td>
        <td></td>
      </tr>
        ...
        <td class="container">
          <div class="content">
            <span class="footer-group">
              <a href="https://instagram.com/maxrelogio1?igshid=85qjwqobuc1b">Instagram</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              Email Suporte: maxclockoficial@gmail.com
            </span>
          </div>
        </td>
        <td></td>
